...
;******************************************************************************    
; @brief: ESTA RUTINA GENERA LA CONDICI?N DE INICIO (START) AL BUS I2C Y 
...
;         PARA CONFIRMAR LA RECEPCI?N DE UN BYTE
;         LA CONDICI?N SE DEFINE EN EL REGISTRO I2CCON EN EL BIT ACKDT:
;           1, nack
;           0, ack
; @params: NINGUNO
; @return: NINGUNO
...
;******************************************************************************    
; @brief: ESTA RUTINA GENERA LA CONDICI?N DE PARAR (STOP) AL BUS DE I2C Y 
...
;******************************************************************************    
; @brief: ESTA RUTINA GENERA LA CONDICI?N DE REINICIAR (RESTART) AL BUS DE 
